  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        <div className="links">
          Join Us: 
          <a href="https://discord.gg/s4xZUfvp" target="_blank">Discord</a>
        </div>
      </header>

      <section className="meetup">
        <h2>
          Join us for our next meetup and pop-up art show
        </h2>
        ...
        <div>
          <strong>Feb 25, 2023</strong> <strong>6 pm - 10 pm</strong><br/>
